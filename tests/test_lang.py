...
def test_binary_op():
    ...
    assert (
        "([] ([14] ([31 14] ([4 31 14] ([4 4 31 14] ([4 4 4 31 14] ([4 4 4 4 31 14] ([4 4 4 4 4 31 14] ([4 4 4 4 4 4 31 14] ([4 4 4 4 4 4 4 31 14] a) * ([57 4 4 4 4 4 4 31 14] b)) + ([60 4 4 4 4 4 31 14] ([4 60 4 4 4 4 4 31 14] a) / ([57 60 4 4 4 4 4 31 14] b))) - ([60 4 4 4 4 31 14] ([4 60 4 4 4 4 31 14] a) & ([57 60 4 4 4 4 31 14] b))) | ([60 4 4 4 31 14] c)) == ([63 4 4 31 14] a)) or ([69 4 31 14] ([4 69 4 31 14] ([4 4 69 4 31 14] a) < ([63 4 69 4 31 14] c)) and ([66 69 4 31 14] ([4 66 69 4 31 14] a) in ([63 66 69 4 31 14] c)))) or ([69 31 14] ([4 69 31 14] a) not in ([63 69 31 14] ([4 63 69 31 14] c) | ([60 63 69 31 14] b))))) ; <EOF>)"
        == l.parse(
...
def test_lambda():
    ...
    assert (
        "([] ([14] ([31 14] ([48 31 14] \\ ([136 48 31 14] x) -> ([138 48 31 14] ([4 138 48 31 14] x) + ([60 138 48 31 14] ([4 60 138 48 31 14] y) & ([57 60 138 48 31 14] x)))))) ; <EOF>)"
