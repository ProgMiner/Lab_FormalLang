...
def test_binary_op():
    ...
    assert (
        "([] ([14] ([31 14] ([4 31 14] ([4 4 31 14] ([4 4 4 31 14] ([4 4 4 4 31 14] ([4 4 4 4 4 31 14] ([4 4 4 4 4 4 31 14] ([4 4 4 4 4 4 4 31 14] a) * ([62 4 4 4 4 4 4 31 14] b)) + ([65 4 4 4 4 4 31 14] ([4 65 4 4 4 4 4 31 14] a) / ([62 65 4 4 4 4 4 31 14] b))) - ([65 4 4 4 4 31 14] ([4 65 4 4 4 4 31 14] a) & ([62 65 4 4 4 4 31 14] b))) | ([65 4 4 4 31 14] c)) == ([68 4 4 31 14] a)) or ([74 4 31 14] ([4 74 4 31 14] ([4 4 74 4 31 14] a) < ([68 4 74 4 31 14] c)) and ([71 74 4 31 14] ([4 71 74 4 31 14] a) in ([68 71 74 4 31 14] c)))) or ([74 31 14] ([4 74 31 14] a) not in ([68 74 31 14] ([4 68 74 31 14] c) | ([65 68 74 31 14] b))))) ; <EOF>)"
        == l.parse(
...
def test_lambda():
    ...
    assert (
        "([] ([14] ([31 14] ([40 31 14] \\ ([134 40 31 14] x) -> ([136 40 31 14] ([4 136 40 31 14] x) + ([65 136 40 31 14] ([4 65 136 40 31 14] y) & ([62 65 136 40 31 14] x)))))) ; <EOF>)"
