...
def test_binary_op():
    ...
    assert (
        "([] ([14] ([31 14] ([4 31 14] ([4 4 31 14] ([4 4 4 31 14] ([4 4 4 4 31 14] ([4 4 4 4 4 31 14] ([4 4 4 4 4 4 31 14] ([4 4 4 4 4 4 4 31 14] a) * ([53 4 4 4 4 4 4 31 14] b)) + ([56 4 4 4 4 4 31 14] ([4 56 4 4 4 4 4 31 14] a) / ([53 56 4 4 4 4 4 31 14] b))) - ([56 4 4 4 4 31 14] ([4 56 4 4 4 4 31 14] a) & ([53 56 4 4 4 4 31 14] b))) | ([56 4 4 4 31 14] c)) == ([59 4 4 31 14] a)) or ([65 4 31 14] ([4 65 4 31 14] ([4 4 65 4 31 14] a) < ([59 4 65 4 31 14] c)) and ([62 65 4 31 14] ([4 62 65 4 31 14] a) in ([59 62 65 4 31 14] c)))) or ([65 31 14] ([4 65 31 14] a) not in ([59 65 31 14] ([4 59 65 31 14] c) | ([56 59 65 31 14] b))))) ; <EOF>)"
        == l.parse(
...
def test_lambda():
    ...
    assert (
        "([] ([14] ([31 14] ([40 31 14] \\ ([134 40 31 14] x) -> ([136 40 31 14] ([4 136 40 31 14] x) + ([56 136 40 31 14] ([4 56 136 40 31 14] y) & ([53 56 136 40 31 14] x)))))) ; <EOF>)"
