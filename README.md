...
- Выражение `load`
    ...
    Файл должен быть в формате CSV, для загрузки используется функция `cfpq_data.graph_from_csv`.

- Математические операции

    Определено 3 унарных и 16 бинарных математических операторов:
    ...
    Для вывода достижимых состояний используется вычисление транзитивно-рефлексивного замыкания КА.
