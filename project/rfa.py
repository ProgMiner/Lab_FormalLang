...
class Nonterminal:
    ...
    def __repr__(self):
        return f"Nonterminal({repr(self._value)})"
...
def intersect_with_fa(a: RFA, b: EpsilonNFA) -> EpsilonNFA:
    """
    Intersects RFA with FA. Returns FA, that is when used in RFA with boxes with
    boxes of input RFA, will be box of start non-terminal.
    """
